...
function registerWaitOnSubs(register, collectionName, mode) {
	var collConf = AdminConfig.collections[collectionName];
	var waitOn = ((collConf && collConf.routes || {})[mode] || {})["waitOn"]
	                || function () { return []; };
	var subs = _.flatten([waitOn()]);
	subs.forEach(function (sub) {
		register(sub.subscriptionId, sub);
	});
}
...
fadminRoutes.route('/view/:collectionName',{
	...
	subscriptions : function(params) {
		registerWaitOnSubs(this.register.bind(this), params.collectionName, "view");
	},
...
fadminRoutes.route('/new/:collectionName',{
	...
	subscriptions : function(params) {
		registerWaitOnSubs(this.register.bind(this), params.collectionName, "new");
	},
	action: function(params)
...
fadminRoutes.route('/edit/:collectionName/:_id',{
	...
	subscriptions : function(params){
		...
		registerWaitOnSubs(this.register.bind(this), params.collectionName, "edit");
	},
	action: function(params)
	{
		if(params.collectionName == 'Users')
